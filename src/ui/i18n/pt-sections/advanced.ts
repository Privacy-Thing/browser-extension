...
export const advanced = {
  ...
  display: {
    ...
    language: {
      title: "Idioma",
      description: `${BRAND_DISPLAY_NAME} segue o idioma do navegador em Automático. Escolha um idioma para usá-lo no lugar.`,
      ...
      reportLabel: "Encontrou um erro de tradução? Informe",
